...
class CacheController:
    def __init__(self, cache_size: int, block_size: int, mapping_strategy: MappingStrategy, replacement_algorithm: ReplacementAlgorithm, write_policy: WritePolicy, main_memory: MainMemory):
